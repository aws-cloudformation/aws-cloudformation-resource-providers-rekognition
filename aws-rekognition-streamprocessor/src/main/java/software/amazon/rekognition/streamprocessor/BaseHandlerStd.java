...
public abstract class BaseHandlerStd extends BaseHandler<CallbackContext> {
  public static String CREATE_CALL_GRAPH_NAME = "AWS-Rekognition-StreamProcessor::Create";
  public static String READ_CALL_GRAPH_NAME = "AWS-Rekognition-StreamProcessor::Describe";
  public static String UPDATE_CALL_GRAPH_NAME = "AWS-Rekognition-StreamProcessor::Update";
  public static String DELETE_CALL_GRAPH_NAME = "AWS-Rekognition-StreamProcessor::Delete";
  public static String LIST_CALL_GRAPH_NAME = "AWS-Rekognition-StreamProcessor::List";
  public static String LIST_TAGS_CALL_GRAPH_NAME = "AWS-Rekognition-StreamProcessor::ListTagsForResource";
  public static int STREAM_PROCESSOR_NAME_MAX_LENGTH = 128;
  ...
  protected BaseHandlerException handlerError(final Exception exception, final Logger logger) {
    if (exception instanceof AccessDeniedException) {
      ...
      logger.log("An Amazon Rekognition service limit was exceeded. Try your call again.");
      return new CfnServiceLimitExceededException(exception);
    ...
    } else if (exception instanceof ResourceAlreadyExistsException || exception instanceof ResourceInUseException) {
